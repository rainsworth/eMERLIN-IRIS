...
singularity exec --cleanenv -H $PWD -B data/:$PWD/data -B pipeline/:$PWD/pipeline jupyter-casa.simg printenv

singularity exec --cleanenv -H $PWD -B data/:$PWD/data -B pipeline/:$PWD/pipeline jupyter-casa.simg './runjupyter_eMERLIN_CP.sh'
